...
export default function User({user,id}) {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-lime-500 brightness-125 translate-y-[60%] group-hover:translate-y-[0%]  transition-transform duration-300  rounded-3xl rotate-6" />
      ...
      <p className="text-transparent text-center group-hover:text-lime-500 group-hover:brightness-150 bg-transparent group-hover:bg-black p-3 rounded-3xl relative z-10 duration-300 group-hover:white group-hover:text-xl group-hover:mb-3 ">
